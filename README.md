...
<p class='util--hide'>View <a href='https://learn.co/lessons/ruby-instance-variables-lab'>Instance Variables</a> on Learn.co and start learning to code for free.</p>
